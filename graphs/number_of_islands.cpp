...
// this code is valid if diagnols are considered
class Solution1 {
private:
    void bfs(int row,int col,int rows,int cols,vector<vector<char>>& grid, vector<vector<int>> &vis){
...
// this code is valid if diagonals are not considered
